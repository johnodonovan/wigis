...
public class ClassScope {
	 ...
	 */
	public static List<String> getLoadedLibraries(final ClassLoader[] loaders) {
		if (loaders == null) {
		...
		for (int l = 0; l < loaders.length; ++l) {
			...
			if (loader != null) {
				...
				for(int i = 0; i < libraries.length; i++){
					...
					String libName = libraries[i].substring(libraries[i].lastIndexOf("/") + 4);
					//System.out.println(libName);
					resultList.add(libName);
				}
			}
		}
